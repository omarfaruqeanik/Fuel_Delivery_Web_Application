...
@keyframes invert-orbit {
  ...
  <body>
<div class="txt1">ACCESS DENIED</div>
<div class="txt2">You can't access here! Withour Login</div>
...
<a href="{{url('login')}}"><div class="button">LOGIN</div></a>
</body>
</html>