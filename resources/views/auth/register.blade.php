    ...
    <!-- Uren's Header Main Area End Here -->
        ...
        <div class="uren-login-register_area">
            <div class="container-fluid">
                ...
                <form id="login-form" action="#" role="form" style="display: block;" method="POST" action="{{ route('register') }}"> @csrf <div class="form-group">
                            <div class="login-form">
                                <h4 class="login-title">Register</h4>
                                <div class="row">
                                    <div class="col-md-6 col-12 mb--20">
                                        <label>First Name</label>
                                        <input type="name" name="name" value="{{ old('name') }}" id="name" tabindex="1" class="input100 form-control @error('name') is-invalid @enderror" placeholder="Enter here your Name" autocomplete="name"> @error('name') <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span> @enderror <span class="focus-input100" data-placeholder="&#xe80f;"></span>
                    
                                    </div>
                                    <div class="col-md-6 col-12 mb--20">
                                        <label>Email Address*</label>
                                        <input type="email" name="email" value="{{ old('email') }}" id="email" tabindex="1" class="input100 form-control @error('email') is-invalid @enderror" placeholder="Enter here your Email" autocomplete="email"> @error('email') <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                        </span> @enderror <span class="focus-input100" data-placeholder="&#xe80f;"></span>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="password" type="password" class="input100 form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Password"> @error('password') <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span> @enderror <span class="focus-input100" data-placeholder="&#xe80f;"></span>
                                    ...
                                    <input  value='customer' type="text"  name="role" hidden>
                                    <div class="col-12">
