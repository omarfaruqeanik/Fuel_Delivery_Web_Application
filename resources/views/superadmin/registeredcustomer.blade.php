      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
        <div align="right">
          <button type="button" name="create_record" id="create_record" class="btn btn-success btn-sm">Add Customer</button>
        </div>
        <br />
          ...
          <div class="modal-body">
            ...
            <form method="post"  id="sample_form" class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <input type="text" name="name" id="name" placeholder="Enter Here Customer Name" class="form-control" />
                </div>
              </div>
...
$(document).ready(function(){
  ...
  $('#sample_form').on('submit', function(event){
    ...
    if($('#action').val() == 'Add')
    {
      action_url = "{{ route('addcustomer.store') }}";
    }

    if($('#action').val() == 'Edit')
    {
      action_url = "{{ route('addcustomer.update') }}";
    }
  ...
  $(document).on('click', '.edit', function(){
    ...
    $('#form_result').html('');
    $.ajax({
      url :"http://localhost:8000/addcustomer/"+id+"/edit",
      dataType:"json",
      success:function(data)
      {
  ...
  $('#ok_button').click(function(){
    $.ajax({
      url:"http://localhost:8000/addcustomer/destroy/"+user_id,
      beforeSend:function(){
