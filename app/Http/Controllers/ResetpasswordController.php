...
if(request()->ajax())
     {
      ...
      return DataTables::of($data)
                    ->addColumn('action', function($data){
                        $button = '<button type="button" name="edit" id="'.$data->id.'" class="edit btn btn-primary btn-sm"> <i class="fa fa-pencil-square-o"></i> Update Password</button>';
        ...
        $user= User:: all();
        return view('admin.resetpass',compact('user'));
    }
